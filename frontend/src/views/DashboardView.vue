<template>
  <div class="h-screen w-screen overflow-hidden flex flex-col bg-gray-50">
        ...
        <div class="mb-6">
          ...
          <div class="grid grid-cols-2 gap-3">
            ...
            <button @click="showQuickExpenseModal = true"
              class="bg-gradient-to-br from-orange-400 to-orange-600 text-white rounded-2xl p-6 shadow-lg active:scale-95 transition-transform">
              <div class="text-4xl mb-2">⚡</div>
              <div class="font-bold text-base">Chi phí nhanh</div>
              <div class="text-xs opacity-80 mt-1">Ghi chi phí tức thì</div>
            </button>
          </div>
        </div>
          ...
          <div v-else-if="!isCashier">
            ...
            <div class="mb-4">
              ...
              <div class="grid grid-cols-2 gap-3">
                ...
                <button v-if="user?.role === USER_ROLES.MANAGER" @click="showQuickExpenseModal = true"
                  class="bg-gradient-to-br from-orange-400 to-orange-600 text-white rounded-2xl p-6 shadow-lg active:scale-95 transition-transform">
                  <div class="text-4xl mb-2">⚡</div>
                  <div class="font-bold">Chi phí nhanh</div>
                </button>
    ...
    <!-- Quick Expense Modal -->
    <QuickExpenseModal :show="showQuickExpenseModal" @close="showQuickExpenseModal = false" @saved="refreshData" />
